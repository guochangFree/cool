...
public class Constants {
    ...
    public static final String COOL_PROPERTIES_KEY = "cool.properties.file";

    public static final String DEFAULT_COOL_PROPERTIES = "cool.properties";
    ...
    public static final String DEFAULT_DIRECTORY = "cool";

    public static final String DEFAULT_LOADBALANCE = "random";

    public static final String DEFAULT_PROTOCOL = "cool";
    ...
    public static final String DEFAULT_REMOTING_CODEC = "cool";
    ...
    public static final String DEFAULT_THREAD_NAME = "Cool";
...
//    public static final int DEFAULT_REGISTRY_CONNECT_TIMEOUT = 5000;
    ...
    public static final String DEFAULT_REGISTRY = "cool";
    ...
    public static final String DEFAULT_PROMPT = "cool>";
    ...
    public static final String COOL_VERSION_KEY = "cool";
    ...
    @Deprecated
    public static final String SHUTDOWN_WAIT_SECONDS_KEY = "cool.service.shutdown.wait.seconds";

    public static final String SHUTDOWN_WAIT_KEY = "cool.service.shutdown.wait";
    ...
    public static final String STUB_EVENT_KEY = "cool.stub.event";

    public static final boolean DEFAULT_STUB_EVENT = false;

    public static final String STUB_EVENT_METHODS_KEY = "cool.stub.event.methods";
    ...
    public static final String COOL_IP_TO_REGISTRY = "COOL_IP_TO_REGISTRY";

    public static final String COOL_PORT_TO_REGISTRY = "COOL_PORT_TO_REGISTRY";

    public static final String COOL_IP_TO_BIND = "COOL_IP_TO_BIND";

    public static final String COOL_PORT_TO_BIND = "COOL_PORT_TO_BIND";
